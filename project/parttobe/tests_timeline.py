...
class CollectionTaskTestClass(TestCase):
    ...
    def test_can_position_chunks(self):
        ...
        self.assertEqual(task1.dependeds[0].id, 2)
    ...
    def test_task_will_frontload_before_a_dependency_reversed(self):
        ...
        self.assertEqual(line[1], Marker(duty3, timedelta(seconds=5.333333), False))
        self.assertEqual(line[2], Marker(duty3, timedelta(seconds=25.333333), True))
        self.assertEqual(line[3], Marker(task2, timedelta(seconds=25.333333), False))
        self.assertEqual(line[4], Marker(task2, timedelta(seconds=52.0), True))
        self.assertEqual(line[5], Marker(task1, timedelta(seconds=52.0), False))
        self.assertEqual(line[6], Marker(duty4, timedelta(seconds=60.0), True))
        self.assertEqual(line[7], Marker(task1, timedelta(seconds=60.0), True))
    ...
    def test_failed_frozen_veggies(self):
        ...
        self.assertEqual(line[4], Marker(duty9, timedelta(seconds=159.591837), False))
        self.assertEqual(line[5], Marker(task7, timedelta(seconds=184.17517), True))
        ...
        self.assertEqual(line[8], Marker(duty9, timedelta(seconds=639.591837), True))
        self.assertEqual(line[9], Marker(duty6, timedelta(seconds=639.591837), False))
        ...
        self.assertEqual(line[12], Marker(duty6, timedelta(seconds=879.591837), True))
        self.assertEqual(line[13], Marker(task5, timedelta(seconds=879.591837), False))
        self.assertEqual(line[14], Marker(duty2, timedelta(seconds=900.0), True))
        self.assertEqual(line[15], Marker(task5, timedelta(seconds=900.0), True))
        self.assertEqual(line[16], Marker(task1, timedelta(seconds=900.0), False))
        self.assertEqual(line[17], Marker(task1, timedelta(seconds=930.0), True))
